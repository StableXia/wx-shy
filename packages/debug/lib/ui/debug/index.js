...
Component({
  data: {
    ...
    debugLaunch: (0, _debug.isStarted)()
  },
  lifetimes: {
    async attached() {
  ...
  methods: {
    addListeners() {
      _debug.eventBus.on(_debug.EVENT_TYPE.close_debug_page, this.handleCloseModal.bind(this));
    },

    removeListeners() {
      _debug.eventBus.off(_debug.EVENT_TYPE.close_debug_page, this.handleCloseModal.bind(this));
    },
